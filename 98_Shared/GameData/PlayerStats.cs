...
///
/// **M4.1 Phase 05 이동**: <c>02_Server/GameServer/Combat/PlayerStats.cs</c>에서 <c>98_Shared/GameData/</c>로 이동.
/// 헌법 #4 (Shared Code Discipline) 정합 — Formulas.cs가 PlayerStats를 직접 참조하므로
/// 양쪽(서버/클라)이 같은 정의를 컴파일해야 함.
///
...
public sealed class PlayerStats
{
    ...
    // M4.1 Phase 05 박힘: 98_Shared/GameData로 이동. 서버는 이 factory를 그대로 호출.
