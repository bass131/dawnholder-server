...
> 본 문서는 SubAgent 작업 실패 시 *에스컬레이션 절차*. WHY는 [`../policies/subagent-routing.md`](../../00_Document/policies/subagent-routing.md) "에스컬레이션 룰" 절.
...
- **비가역(버킷 c) 동반 실패 = 루프 정지**: push/PR/merge/`Protocol.Version`/trust-boundary 작업이 실패하면 자율 재시도 X → 즉시 사람 게이트 정지 ([`../policies/work-judge.md`](../../00_Document/policies/work-judge.md) 버킷 c 졸업 불가).
...
엔진·정지 게이트 → [`../policies/loop-driver.md`](../../00_Document/policies/loop-driver.md) §3·§5.
...
본 문서 수정 시 *반드시* 함께 갱신:
- [`../policies/subagent-routing.md`](../../00_Document/policies/subagent-routing.md) (에스컬레이션 룰 원칙)
- [`../policies/loop-driver.md`](../../00_Document/policies/loop-driver.md) · [`../policies/work-judge.md`](../../00_Document/policies/work-judge.md) (무인 루프 분기 + 비가역 버킷 c 정지)
