...
| **무인 루프 발견** (loop-driven, M7.5) | 루프가 학습 후보 발견 → `pending-knowledge` 큐 적재 (자율 박제 X) | 영호 승인 후 박제 |

**원칙**: 사용자 확인 없이 박힌 캐시 = *AI 자기 강화 편향* 위험. 사용자 확인 게이트 필수. **무인 루프도 예외 X** — 발견은 [`pending-knowledge`](../../00_Document/ledgers/pending-knowledge.md) 큐에 *제안 누적*, 박제는 영호 승인 게이트 후 (ADR-025 트랙 B "쌓이기만 하고 pull 안 됨" 함정의 pull-분리 회피).
