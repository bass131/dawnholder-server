...
| 2026-05-10 | ADR-012 보강 (Phase 07 책임 단위 정제 + 카테고리 맥락) | "현업 표준" = 한국 MMO 백엔드 카테고리(Rookiss/NCSoft/Nexon)라고 명시. Mirror/FishNet은 *Unity 인디 멀티* 카테고리라 본 프로젝트와 다름을 분명히. 책임 단위 분리/통합 표 추가 — *전부 분리/통합*이 아닌 *책임마다 따로* 결정 원칙. |
