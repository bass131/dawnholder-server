...
빠른 탐색:
- **[ADR/tech-stack/](ADR/tech-stack/)** — 스택·도구체인·환경 (10개: 001 002 003 004 005 010 011 012 017 026)
- **[ADR/gameplay/](ADR/gameplay/)** — 게임 디자인·스코프 (5개: 006 007 008 009 030)
- **[ADR/harness/](ADR/harness/)** — 작업 흐름·문서·훅 (17개: 013 014 015 016 018 019 020 021 022 023 024 025 027 028 029 031 032)
