...
**날짜**: 2026-05-11
**상태**: 채택됨 — *부분 superseded ([ADR-032](ADR-032-loop-driven-operation.md), 2026-06-18): 본인 회고 축 = ADR-025로 은퇴 / Codex 재편집 축 → Claude 단독(notion-claude-direct-only). 3자 분업 → 사실상 1자 생존*
