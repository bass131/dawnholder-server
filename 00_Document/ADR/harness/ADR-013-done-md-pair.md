...
**날짜**: 2026-05-10
**상태**: 채택됨
**결정**: Phase 완료 시 `01_Phases/<본인 네임스페이스>/M{N}-{slug}/{NN}-{phase-name}-DONE.md`를 **AI가 작성**해 사실·결정·증상·키워드를 박제한다 (5단계 보고 직후 같은 응답에서). 학습 일지(`00_Document/learning-journal/<본인 네임스페이스>/`)는 본인이 작성. AI는 인터뷰만.
