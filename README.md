...
- **AI 운영 5계층**: 헌법(L1) + 서브에이전트 9(L2) + 슬래시 커맨드 10(L3) + 검증 훅 7(L4) + 지식 캐시 5(L5) — 아래 표
- **실행 데모**: self-contained GameServer + Unity 클라이언트 시연 빌드 (2026-06 캡스톤 1차 발표)
