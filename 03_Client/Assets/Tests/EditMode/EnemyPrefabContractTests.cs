...
namespace Dawnholder.Client.Tests
{
    ...
    public class EnemyPrefabContractTests
    {
        ...
        public void Table_HasNormalEntry()
        {
            ...
            GameObject? prefab = _table!.GetPrefab(RemoteEnemy.EnemyKind.Normal);
        ...
        {
            GameObject? prefab = _table!.GetPrefab(RemoteEnemy.EnemyKind.Boss);
        ...
        [Test]
        public void NormalPrefab_HpBarFillWired() => AssertHpBarWired(RemoteEnemy.EnemyKind.Normal);

        [Test]
        public void BossPrefab_HpBarFillWired() => AssertHpBarWired(RemoteEnemy.EnemyKind.Boss);
        ...
        void AssertHpBarWired(RemoteEnemy.EnemyKind kind)
        {
