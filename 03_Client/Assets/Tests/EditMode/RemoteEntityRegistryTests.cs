...
namespace Dawnholder.Client.Tests
{
    ...
    public class RemoteEntityRegistryTests
    {
        ...
        public void NeedsVisualSwap_RecordedNull_ReturnsTrue()
        {
            ...
            bool result = RemoteEntityRegistry.NeedsVisualSwap(null, CharacterClass.Warrior);
        ...
        public void NeedsVisualSwap_SameClass_ReturnsFalse()
        {
            ...
            bool result = RemoteEntityRegistry.NeedsVisualSwap(CharacterClass.Warrior, CharacterClass.Warrior);
        ...
        {
            // 직업 변경(Warrior → Ranger) → 올바른 직업 비주얼로 교체.
            bool result = RemoteEntityRegistry.NeedsVisualSwap(CharacterClass.Warrior, CharacterClass.Ranger);
            Assert.IsTrue(result);
        }

        [Test]
        public void NeedsVisualSwap_RangerToRanger_ReturnsFalse()
        {
            bool result = RemoteEntityRegistry.NeedsVisualSwap(CharacterClass.Ranger, CharacterClass.Ranger);
            Assert.IsFalse(result);
        }
        ...
        public void NeedsVisualSwap_IncomingNull_ReturnsFalse()
        {
            ...
            Assert.IsFalse(RemoteEntityRegistry.NeedsVisualSwap(CharacterClass.Warrior, null));
